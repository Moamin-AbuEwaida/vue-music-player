<template>
  <div v-if="!isPlayerVisible">
    <div class="text-green-600 font-bold text-center text-3xl mb-7 mt-3">
      VueJS Music App
    </div>
    <div
    ...
    >
      <div>
        <span class="text-green-300">{{ song.name }}</span> <br />
      ...
      <div>
        <img class="max-h-12 rounded" v-bind:src="song.src" alt="" />
      </div>
    </div>
  </div>
  <div v-if="isPlayerVisible">
